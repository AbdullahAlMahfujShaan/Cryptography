...
public class MainActivity {
    ...
    public static void test_encrypt_decrypt() throws Exception {
        String s = readFile("G:\\Cryptography\\Code\\src\\plaintext.txt");
        String res = encrypt("mykey", IV, s);
        PrintWriter writer = new PrintWriter("G:\\Cryptography\\Code\\src\\crypto.txt", "UTF-8");
        writer.print(res);
        writer.close();
    ...
    public static void test_read_file() throws Exception {
        String s = readFile("G:\\Cryptography\\Code\\src\\plaintext.txt");
        System.out.println("G:\\Cryptography\\Code\\src\\plaintext.txt:\n" + s);
    }
    ...
    public static void test_doCrypto(String filename) throws Exception {
        String key = "North South University";
